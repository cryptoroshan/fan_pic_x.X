...
#ifndef BOARD_3A006_H
#define	BOARD_3A006_H
...
#define     TRISB_INIT          0b00111100  	// this MUST agree with the #defines below
...
static char TACH_FIELD[NUM_TACH] = {1<<2, 1<<3};
...
#define AN10 0b00101011
#define AN11 0b00101111
#define AN12 0b00110011


//Vs1, Vs2, , Vs3, 5V, 3.3V_AUX, 12V_AUX, -12V_AUX where Vs1 is typically 12V, Vs2 typically 3.3V but can be 12V, Vs5 which is 5V

//switches between PRIM and ALT voltages
#define KEYINDEX 1
#define KEYTHRESHOLD 7 
const float PRIM_VOLTAGE_LEVELS[NUM_VOLTAGE] = {12.0f, 3.3f, 5.0f, 3.3f, 12, -12};
const float PRIM_VOLTAGE_DIV[NUM_VOLTAGE] = {DIV_12, DIV_3, DIV_5, DIV_3, DIV_12, DIV_M12};

const float ALT_VOLTAGE_LEVELS[NUM_VOLTAGE] = {12.0f, 12.0f, 5.0f, 3.3f, 12, -12};
const float ALT_VOLTAGE_DIV[NUM_VOLTAGE] = {DIV_12, 2.571, DIV_5, DIV_3, DIV_12, DIV_M12};

const uint8_t VOLTAGE_PORT[NUM_VOLTAGE] = {AN11, AN2, AN3, AN12, AN10, AN4};
const uint8_t TEMP_PORT[NUM_TEMP] = {AN0, AN1};
const uint8_t TACH_DIVS_MAP[6] = {0,0,1,2,4,2};

const uint8_t TACH_INDEX_TO_FAN[NUM_TACH] = {0,1};
